		...
		<main id="main" class="site-main single-building" role="main">
            ...
            <h3>Les appartements de l'immeuble <b><?php the_title()?></b> : </h3>
                ...
                <div class="btn-group" role="group" aria-label="...">
                  <button type="button" class="btn btn-default btn-success">Disponibles</button>
                  <button type="button" class="btn btn-default btn-danger">LouÃ©s</button>
                </div>
                <span>Trier par :</span>
                <div class="btn-group" role="group" aria-label="...">
                  <button type="button" class="btn btn-default">MÂ²</button>
                  <button type="button" class="btn btn-default">Prix</button>
                </div>
                <div class="result">
                    <?php   //Get all immeubles
                        ...
                        foreach ($appartments as $appartmentId){
                            ...
                            if ($occuped == 1)
                                $dispoText = "lou� jusqu'au 01/01/2016";
                             else
                            ...
                            ?>
                            <div class="appartment-thumb col-md-3">
                            ...
                            <div class="col-xs-8 text-right offer-update">
                                <p>Libéré le 22/07/2015</p>
                            </div>
				            </div>
                                                ...
                                                <div class="row forth-row">
                                                    <div class="col-xs-12">
                                                                ...
                                                                <span class="offer-area-number">41</span> m² environ                                &nbsp;&nbsp;&nbsp;<span class="offer-rooms-number">2</span> pièces                            </p>
                                                    </div>
                                                </div>
                                </div>
